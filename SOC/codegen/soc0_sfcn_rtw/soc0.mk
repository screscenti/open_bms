...
MODEL              = soc0
MODULES            = rtGetInf.c rtGetNaN.c soc0_sf_data.c 
MAKEFILE           = soc0.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = C:\Sagar\Projects\BMS\P006n\08_Work_in_progress\WP3_2_BMS_Stage_1\SOC\codegen
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 1
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          = optimized_floating_point=1 MODELLIB=soc0lib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\soc0_sfcn_rtw
