...
MODEL              = OL_HiLData
MODULES            = HostLib_rtw.c OL_HiLData_acc_data.c can_datatype_ground.c hostlib_vntcan.c 
MAKEFILE           = OL_HiLData.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = D:\Projects\BMS\P006n\08_Work_in_progress\Repo_Sync_folder\OpenLoopDataSendCAN
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 1
...
SHARED_BIN_DIR     = 
SHARED_LIB         = 
MEX_OPT_FILE       = -f "C:\Users\nctzv8\AppData\Roaming\MathWorks\MATLAB\R2015b\mex_C_win64.xml"
COMPUTER           = PCWIN64
VISUAL_VER         = 12.0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\vnt\vntblks\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\shared\can\src\scanutil
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\OL_HiLData
