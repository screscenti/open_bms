...
extern void pkn_200ms_model_task(void);

/* Handles for tasks and resources. */
extern const PKN_TASK_HANDLE_T pkn_task_200ms_task_hdl;
extern const PKN_PERIODIC_TASK_HANDLE_T pkn_task_200ms_periodic_hdl;
