...
##
##  Project:        OpenECU
##  Version:        $Id: BMShil.mk 49241 2015-12-07 18:03:38Z cforhart $
##  File:           $URL: https://aetius.ps.local/svn/OpenECU/development/platform/branches/release-2.8.0-r2019-1-rc2/openecu/rtw/c/openecu_ert/BMShil.mk $
...
TID01EQ                       = 0
NCSTATES                      = 0
BUILDARGS                     = optimized_floating_point=1 INCLUDE_MDL_TERMINATE_FCN=0 MAT_FILE=0 GENERATE_ASAP2=0 EXT_MODE=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 MAX_DD_LENGTH=31 CONT_IF_VISION_STRATEGY_FAILS=0 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING                  = 0
GEN_IMAGE_SRECORD             = 1
GEN_IMAGE_HEX                 = 1
GEN_ASAP_GENERIC              = 1
...
ADD_INCLUDES                  =  D:\Projects\BMS\P006n\08_Work_in_progress\Repo_Sync_folder\HiLCAN\BMShil_r2015.2_64_oe_2.8.0_r2019_1_ert  D:\Projects\BMS\P006n\08_Work_in_progress\Repo_Sync_folder\HiLCAN 
INTEGER_CODE                  = 0
ONESTEPFCN                    = 1
B_ERTSFCN                     = 0
MEXEXT                        = mexw64
...
MODELREFS                     = BMO BSC BTC CB CC SOC soh sop VITM 
MODELLIB                      = BMShillib.a
MODELREF_LINK_LIBS            = BMO_rtwlib.a BSC_rtwlib.a BTC_rtwlib.a CB_rtwlib.a CC_rtwlib.a SOC_rtwlib.a VITM_rtwlib.a soh_rtwlib.a sop_rtwlib.a 
MODELREF_LINK_RSPFILE         = BMShil_ref.rsp
