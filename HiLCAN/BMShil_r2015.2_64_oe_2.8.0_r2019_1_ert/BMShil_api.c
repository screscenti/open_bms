 ...
 *                  Do not modify.
 *                  Created on: Mon Apr 19 15:45:51 2021 
 *
 *****************************************************************************
 */
...
const U8 psc_app_name[]           = "New_model_v0.0.0_M110_000";
...
const U16 psc_app_build_sec = 51;
const U16 psc_app_build_min = 45;
const U16 psc_app_build_hour = 15;
const U16 psc_app_build_day = 19;
const U16 psc_app_build_month = 4;
const U16 psc_app_build_year = 2021;
#pragma section CONST
#pragma section SCONST
#else
const U16 psc_app_build_sec  __attribute__ ((section(".text_data"))) = 51;
const U16 psc_app_build_min  __attribute__ ((section(".text_data"))) = 45;
const U16 psc_app_build_hour  __attribute__ ((section(".text_data"))) = 15;
const U16 psc_app_build_day  __attribute__ ((section(".text_data"))) = 19;
...
const U8 psc_app_build_str[]         = "Mon, 19 Apr 2021, 15:45:51";
...
const PCX_HANDLE_T pcx_tot_allow_msg_tx = 14;
const PCX_HANDLE_T pcx_tot_allow_msg_rx = 26;

PCX_RX_MSG_T pcx_rx_msg[26];
PCX_HANDLE_T pcx_sorted_rx_msg[26];

PCX_TX_MSG_T pcx_tx_msg[14];
PCX_HANDLE_T pcx_queued_tx_list[15][PCX_NUM_CAN_DEVICES];
