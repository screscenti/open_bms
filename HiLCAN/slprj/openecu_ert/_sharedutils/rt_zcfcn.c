...
ZCEventType rt_ZCFcn(ZCDirection zcDir, ZCSigState* prevZc, FREAL currValue)
{
  ...
  slZcEventType prevEv = (slZcEventType)(((U8)(*prevZc)) >> 2);
  slZcSignalSignType prevSign = (slZcSignalSignType)(((U8)(*prevZc)) &
    (U8)0x03);
