% Autogenerated file: Wed Apr 14 09:38:12 2021
function writeCodeInfoFcn


% Load a ComponentInterface object from IR
codeIRInfoStruct = load('D:\Projects\BMS\P006n\08_Work_in_progress\Repo_Sync_folder\HiLCAN\slprj\openecu_ert\soh\tmwinternal\tlc\codeIRInfo.mat');
...
% Variable: Var_EO0
Var_EO0 = RTW.Variable(Type_0_R0_V0, 'soh_R_index');
    Var_EO0.Owner           = '';
...
% Variable: Var_EO1
Var_EO1 = RTW.Variable(Type_17_R0_V0, 'soh_R_factors');
    Var_EO1.Owner           = '';
...
% Variable: Var_EO2
Var_EO2 = RTW.Variable(Type_0_R0_V0, 'soh_C_index');
    Var_EO2.Owner           = '';
...
% Variable: Var_EO3
Var_EO3 = RTW.Variable(Type_17_R0_V0, 'soh_C_factors');
    Var_EO3.Owner           = '';
...
% Variable: Var_EO4
Var_EO4 = RTW.Variable(Type_0_R0_V0, 'soh_customer_index');
    Var_EO4.Owner           = '';
...
skippedParameters = [];
      checkDataGraphicalNames(codeInfo.Parameters(1).GraphicalName, 'sohc_current_threshold');


    
    % Setting Parameter#1's implementation  
    codeInfo.Parameters(1).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(2).GraphicalName, 'sohc_customer_filter_coeff');


    
    % Setting Parameter#2's implementation  
    codeInfo.Parameters(2).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(3).GraphicalName, 'sohc_filter_coeff');


    
    % Setting Parameter#3's implementation  
    codeInfo.Parameters(3).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(4).GraphicalName, 'sohc_pct_R_limit');


    
    % Setting Parameter#4's implementation  
    codeInfo.Parameters(4).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(5).GraphicalName, 'sohv_factoryInit_sohc');


    
    % Setting Parameter#5's implementation  
    codeInfo.Parameters(5).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(6).GraphicalName, 'sohv_factoryInit_sohr');
...
% Opaque Data Type
type_RTModel  = embedded.opaquetype('RT_MODEL_soh');
...
% Opaque Data Type
type_localZCE  = embedded.opaquetype('rtZCE_soh');
...
idata_localZCE = RTW.DataInterface('', 'localZCE', Var_localZCE, []);
  ...
  RegistrationFcn_Prototype.HeaderFile = ['soh', '.h'];
    RegistrationFcn_Prototype.SourceFile = ['soh', '.c'];
  
  RegistrationFcn_Prototype.Name = 'soh_initialize';
...
PtrType_0_R1_V0_0_0 = embedded.pointertype;
  ...
  Type_17_R1_V0.BaseType   = Type_0_R1_V0;
    ...
    Arg_ci3.Type = Type_17_R1_V0;
    Arg_ci3.Name = 'rtu_vitm_cell_voltages';
    ...
    Arg_ci4.Type = Type_17_R1_V0;
    Arg_ci4.Name = 'rtu_soc_cells_pct';
    ...
    Arg_ci5.Name = 'rtu_vitm_cells_temp';
    ...
    Arg_ci6.Name = 'rtu_soc_C_factors';
...
PtrType_8_R1_V0_0_0 = embedded.pointertype;
   PtrType_8_R1_V0_0_0.BaseType = Type_8_R1_V0;
    ...
    Arg_ci7.Name = 'rtu_cc_main_contactor';
    ...
    Arg_ci8.Name = 'rtu_cc_charger_contactor';
    ...
    Arg_ci9.Type = PtrType_8_R1_V0_0_0;
    Arg_ci9.Name = 'rtu_cc_prechg_contactor';
  ...
  Type_18_R1_V0.BaseType   = Type_8_R1_V0;
    ...
    Arg_ci10.Type = Type_18_R1_V0;
    Arg_ci10.Name = 'rtu_cb_cmds';
    tmpArgs = [tmpArgs; Arg_ci10];

    tmpActualArgs = [tmpActualArgs; codeInfo.Inports(11)];

                    % Pointer Type: Pointer to 'Type_0_R0_V0'    
Type_32_R0_V0 = embedded.pointertype;
  Type_32_R0_V0.BaseType = Type_0_R0_V0;
  Type_32_R0_V0.ReadOnly = 0; 
  Type_32_R0_V0.Volatile = 0;
        
      codeInfo.Outports(1).Implementation.Identifier = ['o_' codeInfo.Outports(1).Implementation.Identifier];
    
        Arg_co1 = RTW.Argument;
    Arg_co1.Type = Type_32_R0_V0;
    Arg_co1.Name = 'rty_soh_R_index';
    ...
    Arg_co2.Type = Type_17_R0_V0;
    Arg_co2.Name = 'rty_soh_R_factors';
    ...
    Arg_co3.Type = Type_32_R0_V0;
    Arg_co3.Name = 'rty_soh_C_index';
    ...
    Arg_co4.Type = Type_17_R0_V0;
    Arg_co4.Name = 'rty_soh_C_factors';
    ...
    Arg_co5.Type = Type_32_R0_V0;
    Arg_co5.Name = 'rty_soh_customer_index';
...
% Opaque Data Type
type_localB  = embedded.opaquetype('rtB_soh');
...
% Opaque Data Type
type_localDW  = embedded.opaquetype('rtDW_soh');
...
idata_localDW = RTW.DataInterface('', 'localDW', Var_localDW, []);
  ...
  OutputUpdateFcn_Prototype.HeaderFile = ['soh', '.h'];
    OutputUpdateFcn_Prototype.SourceFile = ['soh', '.c'];
  
  OutputUpdateFcn_Prototype.Name = 'soh';
  ...
  InitializeFcn_Prototype.HeaderFile = ['soh', '.h'];
    InitializeFcn_Prototype.SourceFile = ['soh', '.c'];
  
  InitializeFcn_Prototype.Name = 'soh_Init';
  ...
  StartFcn_Prototype.HeaderFile = ['soh', '.h'];
    StartFcn_Prototype.SourceFile = ['soh', '.c'];
  
  StartFcn_Prototype.Name = 'soh_Start';
...
if ~isempty(ss) && rtwprivate('rtwattic','hasSIDMap')
  ...
  if exist('expInports', 'var')
      save soh_mr_codeInfo.mat codeInfo expInports;
  else
      save soh_mr_codeInfo.mat codeInfo;
  end
returnVal = 1;
