 ...
 *                  Do not modify.
 *                  Created on: Wed Apr 14 09:37:12 2021 
 *
 *****************************************************************************
 */
...
#define PKNL_TASK_200MSTASK_PRI  (1UL << (31 - PKNL_TASK_200MSTASK_IDX))
#define PKNL_TASK_200MSTASK_CEIL (PKNL_TASK_200MSTASK_PRI | (PKNL_TASK_200MSTASK_PRI-1))
...
const U16 psc_app_build_sec = 12;
...
#else
const U16 psc_app_build_sec  __attribute__ ((section(".text_data"))) = 12;
...
const U8 psc_app_build_str[]         = "Wed, 14 Apr 2021, 09:37:12";
...
const PKN_TASK_T pkn_task_table[PKNL_NUM_TASKS] =
{
    ...
    { task_200ms, PKNL_TASK_200MSTASK_PRI, PKNL_TASK_200MSTASK_CEIL },
...
const PKN_TASK_HANDLE_T pkn_task_200ms_task_hdl = &pkn_task_table[PKNL_TASK_200MSTASK_IDX];
...
const PKN_PERIODIC_TASK_T pkn_periodic_task_table[PKNL_NUM_PERIODIC_TASKS] =
{
    ...
    {
        &pkn_periodic_records[PKNL_TASK_200MSTASK_PIDX],
        &pkn_periodic_task_overrun_count[PKNL_TASK_200MSTASK_PIDX],
        TRUE,
        0,
        200,
        &pkn_task_table[PKNL_TASK_200MSTASK_IDX]
    },
    {
...
const PKN_PERIODIC_TASK_HANDLE_T pkn_task_200ms_periodic_hdl = &pkn_periodic_task_table[PKNL_TASK_200MSTASK_PIDX];
...
{
    {
        ...
        PKNL_PSP_RECEIVETASK_PRI | PKNL_PSP_PERIODICTASK_PRI | PKNL_TASK_200MSTASK_PRI | PKNL_PKN_IDLETASK_PRI | PKNL_PSP_MCP2515_SPITASK_PRI | PKNL_PSP_MCP2515_DATATASK_PRI | PKNL_PSP_MCP2515_INTTASK_PRI | PKNL_PCX_QEMPTIERTASK_PRI | PKNL_PCX_QEMPTIER_MCP2515TASK_PRI,
        PKNL_PSP_RECEIVETASK_CEIL | PKNL_PSP_PERIODICTASK_CEIL | PKNL_TASK_200MSTASK_CEIL | PKNL_PKN_IDLETASK_CEIL | PKNL_PSP_MCP2515_SPITASK_CEIL | PKNL_PSP_MCP2515_DATATASK_CEIL | PKNL_PSP_MCP2515_INTTASK_CEIL | PKNL_PCX_QEMPTIERTASK_CEIL | PKNL_PCX_QEMPTIER_MCP2515TASK_CEIL,
    },
    {
        &pkn_ceiling_records[PKNL_CAN_QUEUE_RESOURCE],
        PKNL_PCX_QEMPTIERTASK_PRI | PKNL_PCX_CAN_CALLBACKTASK_PRI | PKNL_PCX_QEMPTIER_MCP2515TASK_PRI | PKNL_TASK_200MSTASK_PRI | PKNL_PKN_IDLETASK_PRI | PKNL_PCP_CLIENTTASK_PRI | PKNL_PJ1939_CLIENTTASK_PRI,
        PKNL_PCX_QEMPTIERTASK_CEIL | PKNL_PCX_CAN_CALLBACKTASK_CEIL | PKNL_PCX_QEMPTIER_MCP2515TASK_CEIL | PKNL_TASK_200MSTASK_CEIL | PKNL_PKN_IDLETASK_CEIL | PKNL_PCP_CLIENTTASK_CEIL | PKNL_PJ1939_CLIENTTASK_CEIL,
    },
    {
        &pkn_ceiling_records[PKNL_J1939_BUF_RESOURCE],
        PKNL_PJ1939_CLIENTTASK_PRI | PKNL_TASK_200MSTASK_PRI | PKNL_PKN_IDLETASK_PRI,
        PKNL_PJ1939_CLIENTTASK_CEIL | PKNL_TASK_200MSTASK_CEIL | PKNL_PKN_IDLETASK_CEIL,
    },
    {
        &pkn_ceiling_records[PKNL_PPID_BUF_RESOURCE],
        PKNL_PDG_CLIENTTASK_PRI | PKNL_PISO_CLIENTTASK_PRI | PKNL_TASK_200MSTASK_PRI | PKNL_PKN_IDLETASK_PRI,
        PKNL_PDG_CLIENTTASK_CEIL | PKNL_PISO_CLIENTTASK_CEIL | PKNL_TASK_200MSTASK_CEIL | PKNL_PKN_IDLETASK_CEIL,
    },
    {
        &pkn_ceiling_records[PKNL_PFS_STRUCTS_RESOURCE],
        PKNL_PFS_CLIENTTASK_PRI | PKNL_TASK_200MSTASK_PRI | PKNL_PKN_IDLETASK_PRI | PKNL_PFF_CLIENTTASK_PRI | PKNL_PDG_CLIENTTASK_PRI | PKNL_PDTC_CLIENTTASK_PRI | PKNL_PCP_CLIENTTASK_PRI,
        PKNL_PFS_CLIENTTASK_CEIL | PKNL_TASK_200MSTASK_CEIL | PKNL_PKN_IDLETASK_CEIL | PKNL_PFF_CLIENTTASK_CEIL | PKNL_PDG_CLIENTTASK_CEIL | PKNL_PDTC_CLIENTTASK_CEIL | PKNL_PCP_CLIENTTASK_CEIL,
    },
    {
        &pkn_ceiling_records[PKNL_PFF_BUF_RESOURCE],
        PKNL_PFF_CLIENTTASK_PRI | PKNL_TASK_200MSTASK_PRI | PKNL_PKN_IDLETASK_PRI,
        PKNL_PFF_CLIENTTASK_CEIL | PKNL_TASK_200MSTASK_CEIL | PKNL_PKN_IDLETASK_CEIL,
    },
    {
        &pkn_ceiling_records[PKNL_MCP2515_QUEUE_A_RESOURCE],
        PKNL_PSP_RECEIVETASK_PRI | PKNL_PSP_PERIODICTASK_PRI | PKNL_PSP_MCP2515_SPITASK_PRI | PKNL_PSP_MCP2515_DATATASK_PRI | PKNL_PSP_MCP2515_INTTASK_PRI | PKNL_TASK_200MSTASK_PRI | PKNL_PKN_IDLETASK_PRI | PKNL_PCX_QEMPTIERTASK_PRI | PKNL_PCX_QEMPTIER_MCP2515TASK_PRI,
        PKNL_PSP_RECEIVETASK_CEIL | PKNL_PSP_PERIODICTASK_CEIL | PKNL_PSP_MCP2515_SPITASK_CEIL | PKNL_PSP_MCP2515_DATATASK_CEIL | PKNL_PSP_MCP2515_INTTASK_CEIL | PKNL_TASK_200MSTASK_CEIL | PKNL_PKN_IDLETASK_CEIL | PKNL_PCX_QEMPTIERTASK_CEIL | PKNL_PCX_QEMPTIER_MCP2515TASK_CEIL,
    },
    {
