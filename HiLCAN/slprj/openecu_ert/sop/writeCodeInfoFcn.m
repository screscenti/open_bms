% Autogenerated file: Wed Apr 14 09:38:24 2021
function writeCodeInfoFcn


% Load a ComponentInterface object from IR
codeIRInfoStruct = load('D:\Projects\BMS\P006n\08_Work_in_progress\Repo_Sync_folder\HiLCAN\slprj\openecu_ert\sop\tmwinternal\tlc\codeIRInfo.mat');
...
% Variable: Var_EO0
Var_EO0 = RTW.Variable(Type_0_R0_V0, 'discharge_power_limit');
    Var_EO0.Owner           = '';
...
% Variable: Var_EO1
Var_EO1 = RTW.Variable(Type_0_R0_V0, 'discharge_current_limit');
    Var_EO1.Owner           = '';
...
% Variable: Var_EO2
Var_EO2 = RTW.Variable(Type_0_R0_V0, 'charge_power_limit');
    Var_EO2.Owner           = '';
...
% Variable: Var_EO3
Var_EO3 = RTW.Variable(Type_0_R0_V0, 'charge_current_limit');
    Var_EO3.Owner           = '';
...
skippedParameters = [];
      checkDataGraphicalNames(codeInfo.Parameters(1).GraphicalName, 'bmsc_CellMaxVolt');


    
    % Setting Parameter#1's implementation  
    codeInfo.Parameters(1).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(2).GraphicalName, 'bmsc_CellMinVolt');


    
    % Setting Parameter#2's implementation  
    codeInfo.Parameters(2).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(3).GraphicalName, 'bmsc_NumberInPara');


    
    % Setting Parameter#3's implementation  
    codeInfo.Parameters(3).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(4).GraphicalName, 'bmsc_NumberInSeries');


    
    % Setting Parameter#4's implementation  
    codeInfo.Parameters(4).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(5).GraphicalName, 'sopc_ChargeDerate');


    
    % Setting Parameter#5's implementation  
    codeInfo.Parameters(5).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(6).GraphicalName, 'sopc_ChgFaultDerate');


    
    % Setting Parameter#6's implementation  
    codeInfo.Parameters(6).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(7).GraphicalName, 'sopc_DischargeDerate');


    
    % Setting Parameter#7's implementation  
    codeInfo.Parameters(7).Implementation = [];
      checkDataGraphicalNames(codeInfo.Parameters(8).GraphicalName, 'sopc_DischgFaultDerate');
...
% Opaque Data Type
type_RTModel  = embedded.opaquetype('RT_MODEL_sop');
...
idata_RTModel = RTW.DataInterface('', 'RTModel', Var_RTModel, []);
  ...
  RegistrationFcn_Prototype.HeaderFile = ['sop', '.h'];
    RegistrationFcn_Prototype.SourceFile = ['sop', '.c'];
  
  RegistrationFcn_Prototype.Name = 'sop_initialize';
...
PtrType_8_R1_V0_0_0 = embedded.pointertype;
   PtrType_8_R1_V0_0_0.BaseType = Type_8_R1_V0;
    ...
    Arg_ci3.Name = 'rtu_discharging_status';
...
PtrType_3_R1_V0_0_0 = embedded.pointertype;
   PtrType_3_R1_V0_0_0.BaseType = Type_3_R1_V0;
    ...
    Arg_ci4.Name = 'rtu_cell_temp_high_Fault';
    ...
    Arg_ci5.Name = 'rtu_pack_current_fault';
    ...
    Arg_ci6.Name = 'rtu_pack_voltage_fault';
    ...
    Arg_ci8.Type = Type_17_R1_V0;
    Arg_ci8.Name = 'rtu_internal_resis_scaling_fact';
    tmpArgs = [tmpArgs; Arg_ci8];

    tmpActualArgs = [tmpActualArgs; codeInfo.Inports(9)];

                    % Pointer Type: Pointer to 'Type_0_R0_V0'    
Type_31_R0_V0 = embedded.pointertype;
  Type_31_R0_V0.BaseType = Type_0_R0_V0;
  Type_31_R0_V0.ReadOnly = 0; 
  Type_31_R0_V0.Volatile = 0;
        
      codeInfo.Outports(1).Implementation.Identifier = ['o_' codeInfo.Outports(1).Implementation.Identifier];
    
        Arg_co1 = RTW.Argument;
    Arg_co1.Type = Type_31_R0_V0;
    Arg_co1.Name = 'rty_discharge_power_limit';
    ...
    Arg_co2.Type = Type_31_R0_V0;
    Arg_co2.Name = 'rty_discharge_current_limit';
    ...
    Arg_co3.Type = Type_31_R0_V0;
    Arg_co3.Name = 'rty_charge_power_limit';
    ...
    Arg_co4.Type = Type_31_R0_V0;
    Arg_co4.Name = 'rty_charge_current_limit';
  ...
  OutputUpdateFcn_Prototype.HeaderFile = ['sop', '.h'];
    OutputUpdateFcn_Prototype.SourceFile = ['sop', '.c'];
  
  OutputUpdateFcn_Prototype.Name = 'sop';
...
if ~isempty(ss) && rtwprivate('rtwattic','hasSIDMap')
  ...
  if exist('expInports', 'var')
      save sop_mr_codeInfo.mat codeInfo expInports;
  else
      save sop_mr_codeInfo.mat codeInfo;
  end
returnVal = 1;
